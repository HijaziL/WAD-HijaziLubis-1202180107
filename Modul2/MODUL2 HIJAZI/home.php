...
<body>
    ...
    <h1 align="center" style="color: #6495ED;">EAD HOTEL</h1>
    <h2 align="center" style="color: #6495ED;">Welcome to 5 Star Hotel</h2>
    <br>
    <div class="container ">
        <div class="row">
            <div class="col-lg-4">
                <div class="card text-center" style="width: 18rem; box-shadow:0px 5px 10px 4px #cccc">
                    <img src="assets/img/standart.jpeg" class="card-img-top" alt="standart">
                    ...
                    <div class="card-body grey-color">
                        <form action="booking.php" method="POST">
                            <input type="hidden" name="img" value="assets/img/standart.jpeg">
            ...
            <div class="col-lg-4">
                <div class="card text-center" style="width: 18rem; box-shadow:0px 5px 10px 4px #cccc">
                    <img src="assets/img/superior.jfif" class="card-img-top" alt="superior">
                    <div class="card-body top">
